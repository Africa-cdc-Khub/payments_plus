...
<form id="payment_form" action="payment_confirm.php" method="post">
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
			...
			<span class="keyitem">recurring_number_of_installments:</span>  <input type="text" name="recurring_number_of_installments" value="6"><br/>
            ...
            <span>merchant_descriptor:</span>         <input type="text" name="merchant_descriptor" value="Swen Store">
    </fieldset>
    <p>
    <fieldset>
