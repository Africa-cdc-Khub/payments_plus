...
function setDefaultsForPaymentDetailsSection() {
    ...
    $("input[name='recurring_amount']").val("10.00");
    $("input[name='amount']").val("10.00");
    $("input[name='currency']").val("GHS");
    $("input[name='locale']").val("en-us");
    $("input[name='bill_to_forename']").val("Noreal");
    $("input[name='bill_to_surname']").val("Name");
    $("input[name='bill_to_email']").val("null@cybersource.com");
    $("input[name='bill_to_phone']").val("+662-2962-000");
    $("input[name='bill_to_address_line1']").val("1295 Charleston Rd");
    $("input[name='bill_to_address_line2']").val("1295 Charleston Rd");
    $("input[name='bill_to_address_city']").val("Mountain View");
