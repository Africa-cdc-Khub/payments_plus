...
<form id="payment_form" action="payment_confirm.php" method="post">
   ...
   <input type="hidden" name="signed_field_names" value="profile_id,access_key,transaction_uuid,signed_field_names,unsigned_field_names,signed_date_time,locale,transaction_type,reference_number,auth_trans_ref_no,card_type,payment_token,card_expiry_date,amount,currency,merchant_descriptor,override_custom_cancel_page,override_custom_receipt_page">
   ...
   <input type="hidden" name="unsigned_field_names" value="signature,consumer_id,bill_to_forename,bill_to_surname,bill_to_email,bill_to_phone,bill_to_address_line1,bill_to_address_line2,bill_to_address_city,bill_to_address_state,bill_to_address_country,bill_to_address_postal_code,customer_ip_address,merchant_defined_data1,merchant_defined_data2,merchant_defined_data3,merchant_defined_data4">
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
            ...
            <span class="keyitem">payment_token:</span> <input type="text" name="payment_token" value="7032420000121621096"><br/>
            <span>card_type:</span>            <input type="text" name="card_type" value="001" maxlength="3"><br/>
			<span>card_expiry_date:</span>            <input type="text" name="card_expiry_date" value="01-2030" maxlength="7"><br/>
			<span>reference_number:</span>            <input type="text" name="reference_number"><br/>
            ...
            <span>merchant_descriptor:</span>         <input type="text" name="merchant_descriptor" value="Swen">
