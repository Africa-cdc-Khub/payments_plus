...
<form id="payment_form" action="payment_confirm.php" method="post">
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
            ...
            <span>locale:</span>                      <input type="text" name="locale"> (en-us, fr-fr, ja-jp)<br/>
            <span>merchant_descriptor:</span>         <input type="text" name="merchant_descriptor" value="put_merchant_name_here">
    </fieldset>
    <p>
    <fieldset>
