        ...
        <div class="content-wrapper">
            ...
            <div class="receipt-details">
                ...
                <div class="receipt-info">
                    <h3>Receipt <div class="info-label">RCPT-{{ str_pad($invoice->id, 6, '0', STR_PAD_LEFT) }}</div></h3>
                    <h3>Date: <div class="info-label">{{ $invoice->paid_at ? $invoice->paid_at->format('d/m/Y') : now()->format('d/m/Y') }}</div></h3>
                    <h3>Payment Status: <div class="info-label">Completed</div></h3>
                    @if($invoice->paid_at)
                    <h3>Payment Date: <div class="info-label">{{ $invoice->paid_at->format('d/m/Y') }}</div></h3>
                    @endif
                </div>
            </div>
            ...
            <div class="payment-info">
                ...
                <p><strong>Payment Date:</strong> {{ $invoice->paid_at ? $invoice->paid_at->format('M d, Y H:i') : 'N/A' }}</p>
                @if($invoice->paidBy)
                <p><strong>Processed By:</strong> {{ $invoice->paidBy->name ?? 'Admin' }}</p>
                @endif
            </div>
