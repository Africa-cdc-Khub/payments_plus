...
@section('page-title', 'Edit Package: ' . $package->name)
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                >
                    ...
                    <option value="group" {{ old('type', $package->type) === 'group' ? 'selected' : '' }}>Group</option>
                    <option value="exhibition" {{ old('type', $package->type) === 'exhibition' ? 'selected' : '' }}>Exhibition</option>
                    <option value="side_event" {{ old('type', $package->type) === 'side_event' ? 'selected' : '' }}>Side Event</option>
                </select>
                @error('type')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input 
                    ...
                    id="max_people" 
                    name="max_people" 
                    value="{{ old('max_people', $package->max_people) }}"
            ...
            <div>
                ...
                <select 
                    ...
                    required
                >
                    <option value="all" {{ old('continent', $package->continent) === 'all' ? 'selected' : '' }}>All</option>
                    <option value="africa" {{ old('continent', $package->continent) === 'africa' ? 'selected' : '' }}>Africa</option>
                    <option value="other" {{ old('continent', $package->continent) === 'other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('continent')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
