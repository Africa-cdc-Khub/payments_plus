...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="p-6">
            ...
            <form method="GET" action="{{ route('participants.index') }}" class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-2">
                    ...
                    <a href="{{ route('participants.index') }}" class="flex-1 sm:flex-none px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500 transition-colors duration-200 text-sm font-medium text-center">
                        <i class="fas fa-times mr-2"></i>Clear Filters
                    </a>
                    <a href="{{ route('participants.export', request()->query()) }}" class="flex-1 sm:flex-none px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 text-sm font-medium text-center">
