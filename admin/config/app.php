...
return [
    ...
    */
    ...
    'speakers_sponsorship_message' => env('SPEAKERS_SPONSORSHIP_MESSAGE', 'Africa CDC is pleased to inform you that your Visa, Accommodation and Registration fees will be fully covered.'),
