...
function openPdfModal(registrationId, participantId = null) {
    ...
    setTimeout(function() {
        ...
        form.method = 'POST';
        form.action = '<?php echo e(route("invitations.preview")); ?>';
...
<?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/components/invitation-preview-modal.blade.php ENDPATH**/ ?>