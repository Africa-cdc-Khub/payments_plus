...
function openMarkPaidModal(registrationId, registrantName, registrationAmount = '') {
    ...
    // Set form action
    form.action = `<?php echo e(url('registrations')); ?>/${registrationId}/mark-paid`;
...
<?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/components/mark-paid-modal.blade.php ENDPATH**/ ?>