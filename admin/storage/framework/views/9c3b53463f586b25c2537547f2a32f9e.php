...
function openMarkVoidModal(registrationId, registrantName) {
    ...
    // Set form action
    form.action = `<?php echo e(url('registrations')); ?>/${registrationId}/void`;
...
function openBulkVoidModal(registrationIds) {
    ...
    form.action = `<?php echo e(url('registrations/void-bulk')); ?>`;
...
<?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/components/mark-void-modal.blade.php ENDPATH**/ ?>