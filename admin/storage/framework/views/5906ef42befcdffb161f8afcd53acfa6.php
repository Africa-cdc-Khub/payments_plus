...
function openTravelProcessedModal(registrationId, delegateName, isProcessed) {
    ...
    // Set form action
    form.action = `<?php echo e(url('approved-delegates')); ?>/${registrationId}/mark-processed`;
...
<?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/components/mark-travel-processed-modal.blade.php ENDPATH**/ ?>