...
function openEditInvoiceModal(invoiceId, invoiceData) {
    ...
    // Set form action
    form.action = `<?php echo e(url('/invoices')); ?>/${invoiceId}`;
...
<?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/components/edit-invoice-modal.blade.php ENDPATH**/ ?>