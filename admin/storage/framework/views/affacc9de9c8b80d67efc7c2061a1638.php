...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b">
        ...
        <form method="GET" class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-2">
                ...
                <a href="<?php echo e(route('certificates.index')); ?>" class="flex-1 sm:flex-none px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500 transition-colors duration-200 text-sm font-medium text-center">
    ...
    <div class="overflow-x-auto">
        <form id="bulkCertificateForm" method="POST" action="<?php echo e(route('certificates.send-bulk')); ?>">
            <?php echo csrf_field(); ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input 
                                type="checkbox" 
                                name="participants[<?php echo e($loop->index); ?>][registration_id]" 
                                value="<?php echo e($participant['registration_id']); ?>"
                                class="participant-checkbox"
                                data-participant-id="<?php echo e($participant['participant_id']); ?>"
                            >
                            <?php if($participant['participant_id']): ?>
                            <input 
                                type="hidden" 
                                name="participants[<?php echo e($loop->index); ?>][participant_id]" 
                                value="<?php echo e($participant['participant_id']); ?>"
                            >
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">#<?php echo e($participant['registration_id']); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                <?php if($participant['type'] === 'individual'): ?> bg-blue-100 text-blue-800
                                <?php elseif($participant['type'] === 'group_focal'): ?> bg-green-100 text-green-800
                                <?php else: ?> bg-purple-100 text-purple-800
                                <?php endif; ?>">
                                <?php if($participant['type'] === 'individual'): ?>
                                    Individual
                                <?php elseif($participant['type'] === 'group_focal'): ?>
                                    Group (Focal)
                                <?php else: ?>
                                    Group Participant
                                <?php endif; ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            ?>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                <?php if($status === 'Paid'): ?> bg-green-100 text-green-800
                                <?php elseif($status === 'Approved'): ?> bg-blue-100 text-blue-800
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button 
                                type="button"
                                onclick="previewCertificate(<?php echo e($participant['registration_id']); ?>, <?php echo e($participant['participant_id'] ?: 'null'); ?>)"
                            ...
                            <a 
                                href="<?php echo e(route('certificates.download')); ?>?registration_id=<?php echo e($participant['registration_id']); ?><?php if($participant['participant_id']): ?>&participant_id=<?php echo e($participant['participant_id']); ?><?php endif; ?>"
                            ...
                            <button 
                                type="button"
                                onclick="sendCertificate(<?php echo e($participant['registration_id']); ?>, <?php echo e($participant['participant_id'] ?: 'null'); ?>, '<?php echo e(addslashes($participant['name'])); ?>')"
    ...
    <div class="px-6 py-4 border-t border-gray-200">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-700">
                Showing <?php echo e((($currentPage - 1) * $perPage) + 1); ?> to <?php echo e(min($currentPage * $perPage, $total)); ?> of <?php echo e($total); ?> participants
            </div>
            <div class="flex space-x-2">
                <?php if($currentPage > 1): ?>
                <a href="<?php echo e(route('certificates.index', array_merge(request()->query(), ['page' => $currentPage - 1]))); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/certificates/index.blade.php ENDPATH**/ ?>