...
<?php if($admin && in_array($admin->role, ['admin', 'travels','secretariat','finance'])): ?>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo e(number_format($stats['total_participants'])); ?></p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo e(number_format($stats['paid_participants'])); ?></p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo e(number_format($stats['pending_payments'])); ?></p>
                <p class="text-xs text-gray-400 mt-1">Excluding delegates</p>
                <?php if($stats['pending_invoices_revenue'] > 0): ?>
                <small class="text-gray-500 image.png">Invoice value: $<?php echo e(number_format($stats['pending_invoices_revenue'], 2)); ?></small>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <?php if($stats['pending_invoices_revenue'] > 0): ?>
                <small class="text-gray-500 image.png">Invoice value: $<?php echo e(number_format($stats['paid_invoices_revenue'], 2)); ?></small>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-xl font-bold text-indigo-600"><?php echo e(number_format($stats['delegates']['total'])); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-xl font-bold text-green-600"><?php echo e(number_format($stats['delegates']['approved'])); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-xl font-bold text-yellow-600"><?php echo e(number_format($stats['delegates']['pending'])); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-xl font-bold text-red-600"><?php echo e(number_format($stats['delegates']['rejected'])); ?></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $recent_registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($registration->user->full_name); ?></div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($payment->user->full_name); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($payment->package->name); ?></div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($payment->payment_completed_at?->format('M d, Y')); ?>
...
// Delegate Categories Chart
const delegateCategoryData = <?php echo json_encode($delegateCategoryStats, 15, 512) ?>;
...
// Delegate Approvals Chart
const delegateApprovalData = <?php echo json_encode($delegateApprovalStats, 15, 512) ?>;
...
// Continent Chart
const continentData = <?php echo json_encode($continentStats, 15, 512) ?>;
...
// Nationality Chart
const nationalityData = <?php echo json_encode($nationalityStats, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/homebrew/var/www/payments_plus/admin/resources/views/dashboard/index.blade.php ENDPATH**/ ?>