...
// Support email configuration (use admin email for support)
define('SUPPORT_EMAIL', $_ENV['ADMIN_EMAIL'] ?? 'admin@cphia2025.com');
define('SUPPORT_NAME', $_ENV['ADMIN_NAME'] ?? 'CPHIA 2025 Admin');
