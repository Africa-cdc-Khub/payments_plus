...
try {
    ...
    if (isset($_GET['code']) && isset($_GET['state'])) {
        ...
        // Manually set the state in session to bypass validation for now
        ...
        if ($success) {
            ...
            $testSubject = 'CPHIA 2025 - OAuth Email Test (Success!)';
            $testBody = '
            <html>
            ...
            $result = $oauth->sendEmail($testEmail, $testSubject, $testBody);
            ...
            echo "<li>Tokens will auto-refresh automatically</li>";
            echo "</ul>";
            echo "</div>";
